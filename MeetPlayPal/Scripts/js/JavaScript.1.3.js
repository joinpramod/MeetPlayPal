...
function ValidatePasswords() {
    var b = document.getElementById("HFOldPassword").value;
    var c = document.getElementById("txtPassword").value;
    ...
    if (d != "") {
        if (b != c) {
            document.getElementById("divAck").innerText = "Please enter correct Old Password";
            return false;
        }
        else {
            if (a != e) {
        ...
        document.getElementById("divAck").innerText = "Please login to post";
        return false;
    }
}
