...
{
    public class Country : ConnManager
    {
        ...
        public bool SetCommandCountry(ref SqlCommand CmdSent)
        {
            SqlCommand Cmd = new SqlCommand("Country_Sp");
            Cmd.CommandType = CommandType.StoredProcedure;


            SqlParameter ParamOptID = Cmd.Parameters.Add("@OptID", SqlDbType.Int);
            SqlParameter ParamCountryId = Cmd.Parameters.Add("@Countryd", SqlDbType.Float);
        ...
        public bool CreateCountry(ref double NewMasterID, SqlTransaction TrTransaction)
        {
            SqlCommand CmdExecute = new SqlCommand();
            if (SetCommandCountry(ref CmdExecute))
            {
                try
                {
